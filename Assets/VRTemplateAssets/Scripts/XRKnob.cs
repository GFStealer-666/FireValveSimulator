...
namespace Unity.VRTemplate
{
    ...
    public class XRKnob : XRBaseInteractable
    {
        ...
        {
            return handle.localEulerAngles.y;  // Assuming knob rotates around Y axis
        }
        private float accumulatedKnobRotation = 0f;  // Add this field

        public float GetAccumulatedRotation()
        {
            return accumulatedKnobRotation;
        }
        ...
        void UpdateRotation(bool freshCheck = false)
        {
            ...
            accumulatedKnobRotation = knobRotation;
