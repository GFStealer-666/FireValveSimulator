namespace FireValveSimulator
{
    ...
    public class HeadphoneWearStepInteractable : MonoBehaviour
    {
        ...
        private void Reset()
        {
            autoConfigureGrabInteractable = true;
        ...
        {
            if (Application.isPlaying || !autoConfigureGrabInteractable)
                return;

            UnityEditor.EditorApplication.delayCall -= AutoConfigureXRComponentsInEditor;
            UnityEditor.EditorApplication.delayCall += AutoConfigureXRComponentsInEditor;
        }
    #endif
        ...
        [ContextMenu("Auto Configure XR Components")]
        public void AutoConfigureXRComponents()
        {
            ResolveReferences();
    ...
    #if UNITY_EDITOR
        private void AutoConfigureXRComponentsInEditor()
        {
            if (this == null || Application.isPlaying || !autoConfigureGrabInteractable)
                return;
